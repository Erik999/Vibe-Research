...
# 2. 把 SKILL.md 放到对应目录下（参考 Claude Code skills 配置）
mkdir -p ~/.claude/skills/global-stock-data && cp SKILL.md ~/.claude/skills/global-stock-data/SKILL.md
...
# 2. Download SKILL.md — copy from this repository
mkdir -p ~/.claude/skills/global-stock-data && cp SKILL.md ~/.claude/skills/global-stock-data/SKILL.md
