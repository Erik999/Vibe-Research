...
**🌐 官网 · [产品预览](#️-产品预览) · [功能](#-功能) · [数据源](#-数据源data-sources) · [快速开始](#-快速开始) · [接入 AI](#-接入-ai) · [合规](#️-合规) · [相关生态](#-相关生态)**
...
- **更新 / 上游**：a-stock-data —— 想跟进最新端点、扩数据源，去这里看；**但即便你不更新，仓库自带的这份也是固定可用的快照，可以一直用。**
...
- **上游**：global-stock-data —— 想要 K线 / 技术指标 / 期权 / SEC 等全量端点，去这里看。
...
Vibe-Research 用到的数据 / 工具，来自同一套自研开源体系：

| 仓库 | 定位 |
|---|---|
| a-stock-data | A 股全栈数据工具包（10 层 · 40 端点）—— 本项目的 A 股数据引擎 |
| global-stock-data | 美股 / 港股全栈数据工具包（7 层 · 17 端点） |
| investment-news | 全球产业链资讯看板（12 赛道一一对应 A 股板块）—— 本项目的资讯源 |
| Agent-Staff | 把公司 Agent 化：每部门一个 AI agent + CEO 参谋长，常驻飞书 |

## 🙏 致谢

- A 股数据引擎：a-stock-data
- 美股 / 港股数据引擎：global-stock-data
- 资讯：investment-news
- 界面设计语言参考并致谢：[HKUDS/Vibe-Trading](https://github.com/HKUDS/Vibe-Trading)
